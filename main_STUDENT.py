...
class FaceRecognitionSystem1:
    def __init__(self, root):
        ...
        button1.place(x=320,y=100,width=150,height=150)
        ...
        button2.place(x=620,y=100,width=150,height=150)
        ...
        button4.place(x=920,y=100,width=150,height=150)
        ...
        button6.place(x=320,y=350,width=150,height=150)
        ...
        button8.place(x=920,y=350,width=150,height=150)
